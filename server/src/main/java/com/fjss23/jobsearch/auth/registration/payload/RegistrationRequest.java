package com.fjss23.jobsearch.auth.registration.payload;
...
public record RegistrationRequest(
        @NotEmpty(message = "{error.not-empty.firstName}") @Size(min = 2, max = 60, message = "{error.size.firstName}")
                String firstName,
        @NotEmpty(message = "{error.not-empty.lastName}") @Size(min = 2, max = 60, message = "{error.size.lastName}")
                String lastName,
        ...
        @NotEmpty(message = "{error.not-empty.password}") @Size(min = 6, max = 40, message = "{error.size.password}")
                String password,
        @NotEmpty(message = "{error.not-empty.repeatPassword}") String repeatPassword) {}
