...
CREATE TYPE workday_type AS ENUM ('FULL_TIME', 'PART_TIME', 'PER_HOURS');

CREATE TYPE work_model AS ENUM ('REMOTE_WORK', 'HYBRID_WORK', 'ON_SITE');
...
CREATE TABLE IF NOT EXISTS jobsearch.selection_process(
    ...
    PRIMARY KEY (job_id, appuser_id),
    FOREIGN KEY (job_id) REFERENCES jobsearch.job (job_id),
